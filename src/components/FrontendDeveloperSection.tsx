...
export default function FrontendDeveloperSection() {
  ...
  return (
    ...
    animate-[shine_4s_linear_infinite]"
        ...
        >
          {["Next.js", "React.js", "JavaScript", "CSS"].map((tech) => (
            <div
              key={tech}
              className="
      ...
      "
        ...
        <div className="mt-8 flex flex-col [@media(min-width:540px)]:flex-row items-start md:items-center gap-4">
          ...
          <div className="inline-flex items-center gap-2 px-6 py-3 text-xs tracking-[0.25em] uppercase font-semibold text-white/60 rounded-full relative z-20">
            Kotlin
          </div>
          {/* About Button */}
          <motion.button
      ...
      {/* Band card removed — non-interactive label shown instead */}
    </motion.section>
  );
}