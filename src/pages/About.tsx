...
export default function About() {
  ...
  useEffect(() => {
    ...
    <head>
      ...
      <title>SHIRSH KUMAR Resume</title>
      <style>
        * {
          margin: 0;
          padding: 0;
    ...
    <body>
      <div class="container">
        <div class="resume-wrapper">
          <!-- Header -->
          <div class="header">
            <img src="https://raw.githubusercontent.com/princekumar-dev74/web-images-link/31f4e55d34521861579bab4ab322372fe7d8cec4/Name%20%3D%20Prince%20Singh.png" alt="SHIRSH KUMAR" class="profile-photo">
            <div class="header-content">
              ...
              <div class="contact-info">
                ...
                <div class="contact-item">
                  <span class="contact-icon">✉︎</span>
                  <a href="mailto:shirshkumar10mv@gmail.com">shirshkumar10mv@gmail.com</a>
                </div>
                <div class="contact-item">
                  <span class="contact-icon">🆆</span>
                  <a href="https://github.com/shirshkumar69" target="_blank">Portfolio Website</a>
                </div>
                <div class="contact-item">
                  <span class="contact-icon">⛆</span>
                  <a href="https://github.com/shirshkumar69" target="_blank">shirshkumar69</a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="content">
            ...
            <section class="section">
              ...
              <div class="summary-text">
                Passionate and self-driven Btech student with a strong interest in frontend development, cybersecurity, and Ai technologies. Skilled in building responsive and interactive web applications and apks using modern frameworks and tools. Enthusiastic about learning new technologies, improving problem-solving skills, and creating innovative digital experiences.
              </div>
            </section>
              ...
              <div class="section-content">
                ...
                <div class="project">
                  <h3>Frontend Showcase Projects</h3>
                        <p>• Built multiple frontend UI projects using React and CSS</p>
            ...
            <section class="section">
              ...
              <div class="education-item">
                <h3>Senior Secondary Education (Class 12 - PCM)</h3>
                <p>Completed Class 12 with Physics, Chemistry, and Mathematics</p>
              </div>
            </section>
        ...
        a.href = url;
        a.download = "SHIRSH_KUMAR_Resume.html";
      ...
      <div className="relative z-20 flex flex-col items-center justify-center min-h-screen gap-8">
        ...
        >
          ...
          >
            ...
            >
              <p>
                I'm currently a Btech student with CSE stream,
                my main interest is not in games like aow they are made and how each code in them works. Before 9th class,
